...
//    private final Map<String, AppOpenAd> appOpenAdMap = new HashMap<>();
    ...
    public void onShowSplash(Activity activity, AppLovinCallback adListener) {
        ...
        interstitialSplash.setRevenueListener(ad -> NarayanLogEventManager.logPaidAdImpression(context,ad, AdType.INTERSTITIAL));
        interstitialSplash.setListener(new MaxAdListener() {
            @Override
            public void onAdLoaded(MaxAd ad) {
    ...
    public void showInterstitialAdByTimes(final Context context, MaxInterstitialAd interstitialAd, final AdCallback callback, final boolean shouldReloadAds) {
        ...
        interstitialAd.setRevenueListener(ad -> NarayanLogEventManager.logPaidAdImpression(context,ad, AdType.INTERSTITIAL));
        interstitialAd.setListener(new MaxAdListener() {
            @Override
            public void onAdLoaded(MaxAd ad) {
    ...
    private void loadBanner(final Activity mActivity, String id, final FrameLayout adContainer, final ShimmerFrameLayout containerShimmer) {
        ...
        adView.setRevenueListener(ad -> NarayanLogEventManager.logPaidAdImpression( mActivity,ad, AdType.BANNER));
    ...
    public void loadNativeAd(Activity activity, ShimmerFrameLayout containerShimmer, FrameLayout nativeAdLayout, String id, int layoutCustomNative) {
        ...
        nativeAdLoader.setRevenueListener(ad -> NarayanLogEventManager.logPaidAdImpression( activity,ad, AdType.NATIVE));
    ...
    public MaxRecyclerAdapter getNativeRepeatAdapter(Activity activity, String id, int layoutCustomNative, RecyclerView.Adapter originalAdapter,
        ...
        MaxNativeAdViewBinder binder = new MaxNativeAdViewBinder.Builder(layoutCustomNative)
                .setTitleTextViewId(com.ads.narayan.R.id.ad_headline)
                .setBodyTextViewId(com.ads.narayan.R.id.ad_body)
                .setAdvertiserTextViewId(com.ads.narayan.R.id.ad_advertiser)
                .setIconImageViewId(com.ads.narayan.R.id.ad_app_icon)
                .setMediaContentViewGroupId(com.ads.narayan.R.id.ad_media)
                .setOptionsContentViewGroupId(com.ads.narayan.R.id.ad_options_view)
                .setCallToActionButtonId(com.ads.narayan.R.id.ad_call_to_action)
                .build();
