...
public class NarayanAppsflyer {
    ...
    private static NarayanAppsflyer narayanAppsflyer;
    public static boolean enableAppsflyer = false;

    public NarayanAppsflyer() {
    }

    public static NarayanAppsflyer getInstance(){
        if (narayanAppsflyer ==null)
            narayanAppsflyer = new NarayanAppsflyer();
        return narayanAppsflyer;
    }
