...
import com.ads.narayan.ads.purchase_billing.util.mapPurchaseTypeOf
...
internal class MIap(
    ...
    internal fun checkSubAndVerify(
        ...
        onVerified: (error: String?, purchase: PurchaseResultTest) -> Unit,
    ) {
    ...
    fun checkPurchaseAndConsume(
        purchases: List<Purchase>?,
        result: BillingResult,
        onConsume: (error: String?, purchase: PurchaseResultTest) -> Unit
    ) {
