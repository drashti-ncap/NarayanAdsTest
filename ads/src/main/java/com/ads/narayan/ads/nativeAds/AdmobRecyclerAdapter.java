...
public class AdmobRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdmobRecyclerAdapter(NarayanAdPlacerSettings settings, RecyclerView.Adapter adapterOriginal, Activity activity) {
        this.adapterOriginal = adapterOriginal;
        this.registerAdapterDataObserver(adapterDataObserver);
        this.activity = activity;
        this.settings = settings;
        adPlacer = new NarayanAdPlacer(settings, adapterOriginal, activity);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == TYPE_AD_VIEW) {
            ...
            return new NarayanViewHolder(view);
        } else {
    ...
    private class NarayanViewHolder extends RecyclerView.ViewHolder {
        public NarayanViewHolder(@NonNull View itemView) {
            super(itemView);
        }
